$(document).ready(function () {
    ...
    $(document).on("click", ".trashed-restore-blog-comment-delete-btn", async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/blogs/comment/trashed/restore', { id: id });
            ...
            if (data.success) {
                ...
                $(this).data('id', '');
                $('#trashed-restore-blog-comment-modal').modal('hide');
            }
