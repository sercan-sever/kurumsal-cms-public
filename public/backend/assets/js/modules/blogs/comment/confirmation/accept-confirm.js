$(document).ready(function () {
    ...
    $(document).on('click', '#add-confirm-blog-comment-btn', async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/blogs/comment/confirm/accept', { id: id, reply_comment: replyComment });
