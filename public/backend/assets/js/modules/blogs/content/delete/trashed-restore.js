$(document).ready(function () {
    ...
    $(document).on("click", ".trashed-restore-blog-delete-btn", async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/blogs/trashed/restore', { id: id });
            ...
            if (data.success) {
                ...
                $(this).data('id', '');
                $('#trashed-restore-blog-modal').modal('hide');
            }
