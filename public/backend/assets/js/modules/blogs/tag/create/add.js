$(document).ready(function () {
    ...
    $(document).on('click', '#add-blog-tag', function () {
    ...
    $(document).on('hidden.bs.modal', '#add-blog-tag-modal', function () {
        resetAddForm();
    });
    ...
    function getMaxOrderValue() {
        let table = $('#blog-tag-lists').DataTable();
