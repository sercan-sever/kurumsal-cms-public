$(document).ready(function () {
    ...
    $(document).on("click", ".trashed-restore-blog-tag-delete-btn", async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/blogs/tag/trashed/restore', { id: id });
            ...
            if (data.success) {
                ...
                let rowToDelete = $('#trashed-blog-tag-lists tbody tr').filter(function () {
                ...
                tableAdd(blogTag, content, blogTagCount, statusHtml);

                $(this).data('id', '');
                $('#trashed-restore-blog-tag-modal').modal('hide');
            }
    ...
    function tableAdd(blogTag, content, blogTagCount, statusHtml) {
