$(document).ready(function () {
    ...
    $(document).on("click", ".trashed-restore-faq-delete-btn", async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/faq/trashed/restore', { id: id });
            ...
            if (data.success) {
                ...
                let rowToDelete = $('#trashed-faq-lists tbody tr').filter(function () {
                ...
                tableAdd(faq, title, statusHtml);

                $(this).data('id', '');
                $('#trashed-restore-faq-modal').modal('hide');
            }
    ...
    function tableAdd(faq, title, statusHtml) {
