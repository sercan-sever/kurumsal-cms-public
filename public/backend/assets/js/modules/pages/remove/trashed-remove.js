$(document).ready(function () {
    ...
    $(document).on("click", ".trashed-remove-page-delete-btn", async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/pages/trashed/remove', { id: id });
            ...
            if (data.success) {
                ...
                $(this).data('id', '');
                $('#trashed-remove-page-modal').modal('hide');
            }
