$(document).ready(function () {
    ...
    $(document).on('click', '#add-page', async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/pages/get-add-view');

            const data = response.data;

            if (data.success) {

                let pageView = data.page;
                $('#add-page-modal-scroll').html(pageView ?? '');
