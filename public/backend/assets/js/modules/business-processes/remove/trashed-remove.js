$(document).ready(function () {
    ...
    $(document).on("click", ".trashed-remove-business-processes-delete-btn", async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/business-processes/trashed/remove', { id: id });

            const data = response.data;

            if (data.success) {
                let businessProcessesId = data.businessProcesses;
                ...
                let rowToDelete = $('#trashed-business-processes-lists tbody tr').filter(function () {
                    return $(this).data('id') == businessProcessesId;
                });
                ...
                $(this).data('id', '');
                $('#trashed-remove-business-processes-modal').modal('hide');
            }
