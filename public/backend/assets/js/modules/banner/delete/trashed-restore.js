$(document).ready(function () {
    ...
    $(document).on("click", ".trashed-restore-banner-delete-btn", async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/banner/trashed/restore', { id: id });
            ...
            if (data.success) {
                ...
                let rowToDelete = $('#trashed-banner-lists tbody tr').filter(function () {
                ...
                tableAdd(banner, content, image, statusHtml);

                $(this).data('id', '');
                $('#trashed-restore-banner-modal').modal('hide');
            }
    ...
    function tableAdd(banner, content, image, statusHtml) {
