$(document).ready(function () {
    ...
    $(document).on("click", ".trashed-restore-user-management-delete-btn", async function (e) {
        e.preventDefault();
        ...
        try {
            // Axios ile istek at
            const response = await axios.post('/lk-admin/user-managements/trashed/restore', { id: id });
            ...
            if (data.success) {
                ...
                let rowToDelete = $('#trashed-user-management-lists tbody tr').filter(function () {
                ...
                $(this).data('id', '');
                $('#trashed-restore-user-management-modal').modal('hide');
            }
