$(document).ready(function () {
    ...
    $(document).on("submit", "#update-form", async function (e) {
        ...
        try {
            ...
            if (data.success) {
                ...
                updateRowTable(service, title, image, statusHtml);
    ...
    function updateRowTable(service, title, image, statusHtml) {
        ...
        let row = datatable.row(`[data-id="${(service.id ?? '')}"]`);
