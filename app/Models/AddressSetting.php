...
class AddressSetting extends Model
{
    ...
    public function content(): BelongsTo
    {
        ...
        return $this->belongsTo(AddressSettingContent::class, 'id', 'address_setting_id')->where('language_id', $siteLangID)->withDefault();
    }
    ...
    {
        return $this->hasMany(AddressSettingContent::class);
    }
}
