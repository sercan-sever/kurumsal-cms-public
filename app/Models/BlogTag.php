...
class BlogTag extends Model
{
    ...
    public function content(): BelongsTo
    {
        ...
        return $this->belongsTo(BlogTagContent::class, 'id', 'blog_tag_id')->where('language_id', $siteLangID)->withDefault();
    }
    ...
    {
        return $this->hasMany(BlogTagContent::class);
    }
    ...
    {
        return $this->belongsToMany(Blog::class, 'blog_tag_blogs', 'blog_tag_id', 'blog_id');
    }
}
