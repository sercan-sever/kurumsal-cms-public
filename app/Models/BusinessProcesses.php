...
class BusinessProcesses extends Model
{
    ...
    public function content(): BelongsTo
    {
        ...
        return $this->belongsTo(BusinessProcessesContent::class, 'id', 'business_processes_id')->where('language_id', $siteLangID)->withDefault();
    }
    ...
    {
        return $this->hasMany(BusinessProcessesContent::class);
    }
}
