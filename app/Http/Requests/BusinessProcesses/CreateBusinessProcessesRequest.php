...
namespace App\Http\Requests\BusinessProcesses;

use App\Traits\Validation\BusinessProcesses\CreateBusinessProcessesValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class CreateBusinessProcessesRequest extends FormRequest
{
    use CreateBusinessProcessesValidation;
