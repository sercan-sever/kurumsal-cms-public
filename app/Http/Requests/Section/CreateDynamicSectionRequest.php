...
use App\Traits\Validation\Sections\CreateSectionDynamicValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class CreateDynamicSectionRequest extends FormRequest
{
    use CreateSectionDynamicValidation;
