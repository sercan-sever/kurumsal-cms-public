...
use App\Traits\Validation\Sections\UpdateSectionDynamicValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class UpdateDynamicSectionRequest extends FormRequest
{
    use UpdateSectionDynamicValidation;
