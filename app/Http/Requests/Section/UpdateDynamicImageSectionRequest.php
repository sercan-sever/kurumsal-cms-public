...
use App\Traits\Validation\Sections\UpdateSectionDynamicImageValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class UpdateDynamicImageSectionRequest extends FormRequest
{
    use UpdateSectionDynamicImageValidation;
