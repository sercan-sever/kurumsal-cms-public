...
use App\Traits\Validation\Sections\UpdateSectionContactFormValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class ContactFormSectionRequest extends FormRequest
{
    use UpdateSectionContactFormValidation;
