...
use App\Traits\Validation\Sections\CreateSectionDynamicImageValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class CreateDynamicImageSectionRequest extends FormRequest
{
    use CreateSectionDynamicImageValidation;
