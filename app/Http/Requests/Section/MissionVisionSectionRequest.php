...
use App\Traits\Validation\Sections\UpdateSectionMissionVisionValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class MissionVisionSectionRequest extends FormRequest
{
    use UpdateSectionMissionVisionValidation;
