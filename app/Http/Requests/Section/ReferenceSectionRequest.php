...
use App\Traits\Validation\Sections\UpdateSectionReferenceValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class ReferenceSectionRequest extends FormRequest
{
    use UpdateSectionReferenceValidation;
