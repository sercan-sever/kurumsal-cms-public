...
use App\Traits\Validation\Sections\UpdateSectionBusinessProcessesValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class BusinessProcessesSectionRequest extends FormRequest
{
    use UpdateSectionBusinessProcessesValidation;
