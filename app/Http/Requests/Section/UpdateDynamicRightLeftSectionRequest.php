...
use App\Traits\Validation\Sections\UpdateSectionDynamicRightLeftValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class UpdateDynamicRightLeftSectionRequest extends FormRequest
{
    use UpdateSectionDynamicRightLeftValidation;
