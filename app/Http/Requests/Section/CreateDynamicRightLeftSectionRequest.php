...
use App\Traits\Validation\Sections\CreateSectionDynamicRightLeftValidation;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Support\Collection;

class CreateDynamicRightLeftSectionRequest extends FormRequest
{
    use CreateSectionDynamicRightLeftValidation;
