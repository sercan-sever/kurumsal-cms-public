...
use App\Mail\SendUserResetPasswordNotification;
...
class SendUserResetPasswordEmailJob implements ShouldQueue
{
    ...
    public function handle(EmailService $emailService): void
    {
        ...
        Mail::to(users: $this->user?->email, name: 'Localkod - Şifre Sıfırlama')->send(new SendUserResetPasswordNotification(
            user: $this->user,
