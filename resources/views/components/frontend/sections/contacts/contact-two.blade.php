        ...
        <div class="row align-items-center">
            <div class="col-lg-12">
                <div class="contact-us-content">
                    <div class="contact-info-list mb-7 mt-7">
                        <div class="row">
                            @php
                                $addressTwo = !empty($setting?->address?->content?->address_title_two) ? 'col-md-3' : 'col-md-4';
                            @endphp
            ...
            <div class="col-lg-12">
                <div class="contact-us-form mt-7">
                    <div class="section-title">
                        <h2 class="text-anime-style-2" data-cursor="-opaque">
                        ...
                        <form id="contact-form" data-action="{{ route('frontend.form.contact', ['lang' => session('locale')]) }}" method="POST" class="wow fadeInUp" data-wow-delay="0.25s">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 mb-4">
                                    ...
                                    <textarea name="message" class="form-control" id="cst-contact-form-message-2" rows="4" placeholder="{{ __('custom.form.message' ?? '') }} *" minlength="1" maxlength="1000" required></textarea>
                                </div>
