...
@if ($loop->first)
    <div class="row cst-mobil-checkbox mb-7">
        <div class="col-md-6 fv-row mb-7 text-center cst-image">
...
<div class="fv-row mb-7">
    ...
    <textarea name="{{ $language?->code }}[short_description]" id="short_description_{{ $language?->id }}" class="form-control form-control-solid cst-description" rows="6" minlength="5" maxlength="4000" placeholder="Kısa Açıklama *"></textarea>
</div>
...
<div class="row">
    <div class="col-md-6 fv-row mb-4 cst-meta-keywords">
        ...
        <textarea name="{{ $language?->code }}[mission]" id="mission_{{ $language?->id }}" class="form-control form-control-solid" rows="4" placeholder="Misyon *" required></textarea>
    </div>
    <div class="col-md-6 fv-row mb-4 cst-meta-descriptions">
        ...
        <textarea name="{{ $language?->code }}[vision]" id="vision_{{ $language?->id }}" class="form-control form-control-solid" rows="4" placeholder="Vizyon *" required></textarea>
    </div>
</div>
