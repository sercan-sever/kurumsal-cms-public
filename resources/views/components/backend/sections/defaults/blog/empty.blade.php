...
@if ($loop->first)
    ...
    <div class="row mb-7">
        ...
        <div class="col-md-6">
            ...
            <select name="page" class="form-control form-select-solid" id="page" data-live-search="true" required @disabled(!empty($disabled))>
...
@if ($loop->first)
    <div class="row cst-mobil-checkbox">
        <div class="col-md-6 fv-row mb-4">
            <label class="required fs-6 fw-semibold mb-2">Gösterim Adet</label>
            <input type="number" name="limit" value="{{ $section?->limit ?? '3' }}" class="form-control form-control-solid" id="limit" placeholder="Gösterim Adet *" min="3" required @disabled(!empty($disabled)) />
        </div>
        <div class="col-md-6 fv-row mb-4">
