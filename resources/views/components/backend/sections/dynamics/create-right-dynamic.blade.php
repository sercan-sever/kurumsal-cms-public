...
@if (empty($disabled))
    <form id="create-form" class="form" data-action="{{ route('admin.pages.section.create.dynamic.right') }}">
        @csrf
@endif
                        ...
                        <div class="card-body">
                            ...
                            @if ($loop->first)
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-7">
                                        ...
                                        <input type="text" name="title" class="form-control form-control-solid" placeholder="Bölüm Başlık *" required />
                                    </div>
                                    <div class="col-md-6 mb-7">
                                        <label class="fs-6 fw-semibold mb-2">Sayfa</label>
                                        <select name="page" class="form-control form-select-solid" id="page" data-live-search="true">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-7">
                                    ...
                                    <input type="text" name="{{ $language?->code }}[heading]" class="form-control form-control-solid" placeholder="Üst Başlık *" minlength="1" required />
                                </div>
                                <div class="col-md-6 mb-7">
                                    <label class="required fs-6 fw-semibold mb-2">Alt Başlık ( {{ $language?->getCodeUppercase() }} )</label>
                                    <input type="text" name="{{ $language?->code }}[sub_heading]" class="form-control form-control-solid" placeholder="Alt Başlık *" minlength="1" required />
                                </div>
                                <div class="col-md-6 mb-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <textarea name="{{ $language?->code }}[description]" id="description_{{ $language?->id }}" class="form-control form-control-solid cst-description ckeditor" rows="6" placeholder="İçerik *"></textarea>
                            </div>
