...
@if (empty($disabled))
    <form id="update-form" class="form" data-action="{{ route('admin.pages.section.update.dynamic.right.left') }}">
        @csrf
                            ...
                            @foreach ($section->allContent as $content)
                                ...
                                @if ($outerLoop->first)
                                    ...
                                    <div class="row cst-mobil-checkbox mb-7">
                                        ...
                                        <div class="col-md-6 fv-row mb-7 text-center">
                                            ...
                                            <div class="text-muted fs-7">
                                                <small class="text-danger">
                                                    Mime: {{ ImageTypeEnum::MIME_ACCEPT->value }} | KB: {{ ImageSizeEnum::SIZE_05->value }} | W-H: 650x650
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-7">
                                    ...
                                    <div class="col-md-6 mb-7">
                                        ...
                                        <input type="text" name="{{ $language?->code }}[button_title]" value="{{ $section?->content?->button_title }}" class="form-control form-control-solid" placeholder="Buton Başlık..." @disabled(!empty($disabled)) />
                                    </div>
                                </div>
